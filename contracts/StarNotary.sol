...
contract StarNotary is ERC721 {
    ...
    string public name='JuaFe Star';
    string public symbol='JFF';
    ...
    //Function to exchange stars between two users
    ...
    //Function to transfer stars
    function transferStar(address _to1, uint256 _tokenId) public {
       if(ownerOf(_tokenId)==msg.sender){
           transferFrom(msg.sender,_to1,_tokenId);
       }else{
           revert("You are not allowed to transfer token");
       }
    }
